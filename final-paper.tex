...
The estimate of the source location was obtained using a particle
filter\cite{maskell2001tutorial}. Given
...
The two planning algorithms as
...
future research that takes into account the fact that there may not
exist a maximum chemical vapor concentration at the true source location.  To gain preliminary intuition regarding the
relative performance of the simple gradient descent planner and the
stochastic planner in such a circumstance 
