...
Data flow between the components of the system is illustrated in
Figure \ref{fig:acquisition}. The estimator receives 


 When the estimator receives each new reading, it updates its model of the
...
filter\cite{maskell2001tutorial}. After  Given
