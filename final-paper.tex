...
same order of magnitude as the average value. The estimator then used
...
\ref{fig:model-fit}, and the parameters of these fitted curves are shown in Table
...
calculated by measuring the average baseline sensor readings over 60 seconds
before each trial began. The computed height offsets for each trial are listed in Table \ref{tab:height-offset}. 
...
\begin{figure}
\begin{center}
\fbox{\includegraphics[width=6in]{img/model-fit.pdf}}
...
end of each trial. Raw chemical sensor readings and the robot position were also logged at a rate of 1 hz.
